...
const Class_card = (props) => {
  ...
  const Type_creature = (props) => {
    return (
      <div>
      <Select isMulti={true} options={type_creature} placeholder={<div>Вид существа</div>} />
      </div>
    )
  }
  ...
  const Keyword_card = (props) => {
    return (
      <div>
      <Select isMulti={true} options={keyword_card} placeholder={<div>Ключевые слова</div>} />
      </div>
    )
  }
  ...
  const Mechanics_card = (props) => {
    return (
      <div>
      <Select isMulti={true} options={mechanics_card} placeholder={<div>Механики карты</div>} />
      </div>
    )
  }

export  {Class_card,Type_card,Type_creature,Rare_card,Mana_card,Attac_card,Life_card,Keyword_card,Mechanics_card};